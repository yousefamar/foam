	...
	publications: [
		{
			...
			link: {
				href: "/assets/papers/PID5999227.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/1570510166.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/citifog18-final7.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/a3-amar.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/1803.05368.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/JREI-D-17-00019.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/US20190129771A1.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/eurodw17-final3.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/p49-mortier.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/p571-amar.pdf",
				label: "PDF"
			}
		}, {
			...
			link: {
				href: "/assets/papers/ondra2015iros.pdf",
				label: "PDF"
			}
		}
	],
	...
	awards: [
		{
			...
			year: "2019",
			image: {
				thumb: "/assets/images/awards/ieee-cog-logo.png",
				alt: "IEEE CoG Logo",
			},
			description: "A £620 grant, awarded by the JP fund, to cover the registration to <a href=\"http://ieee-cog.org/2019/\" target=\"_blank\">IEEE CoG 2019</a> in London (no travel expenses needed!) where Yousef <a href=\"/memo/assets/images/awards/yousef-poster-cog19.jpg\" target=\"_blank\">presented</a> a poster."
		}, {
			name: "EuroSys 2018 Shadow PC and Conference Travel Grant",
			year: "2018",
			image: {
				thumb: "/assets/images/awards/eurosys-logo.png",
				alt: "EuroSys Logo",
			},
			description: "Two travel grants to Shadow PC meeting and top-tier systems conference EuroSys in Porto, Portugal, where Yousef <a href=\"/memo/assets/images/awards/yousef-poster-eurodw18.jpg\" target=\"_blank\">presented</a> a poster and <a href=\"/memo/assets/images/awards/yousef-presenting-eurodw18.jpg\" target=\"_blank\">gave</a> a workshop talk for EuroDW '17 (slides available <a href=\"http://conferences.inf.ed.ac.uk/EuroDW2018/#program\" target=\"_blank\">here</a>) as well as <a href=\"/memo/assets/images/awards/yousef-presenting-wp2ds18.jpg\" target=\"_blank\">giving</a> a workshop talk for the first W-P2DS (slides available <a href=\"/memo/assets/papers/w-p2ds18-presentation.pdf\" target=\"_blank\">here</a>)."
		}, {
			...
			description: "A grant of $500 covering travel and lodging in addition to free registration to top-tier systems conference EuroSys in Belgrade, Serbia, where Yousef <a href=\"/memo/assets/images/awards/yousef-poster-eurodw17.jpg\" target=\"_blank\">presented</a> a poster and <a href=\"/memo/assets/images/awards/yousef-presenting-eurodw17.jpg\" target=\"_blank\">gave</a> a workshop talk (EuroDW '17). Abstract and slides are available <a href=\"https://eurodw17.kaust.edu.sa/workshop.html\" target=\"_blank\">here</a>."
		}, {
			name: "IEEE Circuit Building Competition Winner",
			year: "2017",
			image: {
				thumb: "/assets/images/awards/ieee-student-branch.png",
			...
			year: "2014",
			image: {
				thumb: "/assets/images/awards/PSA-thumb.png",
				alt: "PSA Advanced Award Certificate",
				href: "/assets/images/awards/PSA-small.png"
			},
			...
			year: "2014",
			image: {
				thumb: "/assets/images/awards/PASS-thumb.png",
				alt: "PASS Leader of the Year Certificate",
				href: "/assets/images/awards/PASS-small.png"
			},
			description: "The <a href=\"http://intranet.birmingham.ac.uk/as/libraryservices/pass/whatispass.aspx\" target=\"_blank\">Peer-assisted Study Sessions (PASS)</a> scheme is part of an internationally recognised network where higher year students lead study sessions for lower year students. Yousef was named <a href=\"http://web.archive.org/web/20150816043636/https://intranet.birmingham.ac.uk/as/libraryservices/pass/awards.aspx\" target=\"_blank\">PASS Leader of the Year</a> after successfully setting up the scheme in the department of EECE after lobbying the administration for over a year as Chair of Student Representatives. <a href=\"http://www.birmingham.ac.uk/schools/eece/news/pass-awards.aspx\" target=\"_blank\">Full news article...</a>"
		}, {
			name: "Student Mobile App Competition (SMAC) Winner",
			year: "2014",
			image: {
				thumb: "/assets/images/awards/SMAC-thumb.png",
				alt: "SMAC Certificate",
				href: "/assets/images/awards/SMAC-small.png"
			},
			description: "A competition, led by the university's IT Innovation Centre, thats goal is to prototype the best mobile app that will most benefit the university and students as a whole. The competition was won by writing a marketplace app for students to buy and sell secondhand textbooks with built in messaging. Prizes included an Amazon Kindle Fire HD tablet and a 14 week paid industrial placement offer (which was respectfully declined). <a href=\"https://blog.bham.ac.uk/itinnovation/2014/03/30/student-mobile-app-competition-2013-2014-winners-announced/\" target=\"_blank\">More info...</a>"
		}, {
			name: "IBM Mainframe Challenge 2012 Winner",
			year: "2013",
			image: {
				thumb: "/assets/images/awards/IBM.png",
				alt: "IBM Mainframe Challenge 2012 Logo",
			},
			description: "Achieved by swiftly learning the IBM z/OS mainframe stack (CICS, WebSphere MQ, JCL) and completing a series of systems programming tasks on IBM's own servers. <a href=\"http://www-05.ibm.com/employment/uk/graduate-programmes/mainframe/index.shtml\" target=\"_blank\">More info...</a>"
		}, {
			name: "First Class Excellence Scholarship x4",
			year: "2009-2013",
			image: {
				thumb: "/assets/images/awards/scholarship-thumb.png",
				alt: "First Class Excellence Scholarship Letter",
				href: "/assets/images/awards/scholarship-mall.png"
			},
...
<h6>Publications</h6>
<ul>
	<li><a href="/memo/assets/papers/ondra2015iros.pdf" target="_blank">Incremental Dense Multi-modal 3D Scene Reconstruction</a></li>
</ul>`
		}, {
...
<ul>
	...
	<li>Design Society</li>
			...
			description: `<h3>First class Honours</h3>
...
<ul>
	...
	<li><a href="https://web.archive.org/web/20170829194205/https://faraday-secondary.theiet.org/" target="_blank">Faraday Challenge</a> Volunteer</li>
